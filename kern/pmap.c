...
// The 'pages' array has one 'struct PageInfo *Info' entry per physical page.
// PageInfo *s are reference counted, and free pages are kept on a linked list.
// --------------------------------------------------------------
